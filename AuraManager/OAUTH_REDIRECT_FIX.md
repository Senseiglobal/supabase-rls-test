...
Based on your Google OAuth configuration analysis, the redirect URI being used by AuraManager doesn't exactly match what's configured in Google Cloud Console.
