  ...
  const handleUploadConfirm = () => {
    if (uploadedFile) {
      toast({
        ...
        description: `Analyzing "${uploadedFile.name}" with AuraManager AI...`,
      });
    ...
    <>
      ...
      <Dialog open={showUploadDialog} onOpenChange={setShowUploadDialog}>
        <DialogContent className="sm:max-w-md bg-card border-border">
          <DialogHeader>
            <DialogTitle className="text-foreground">Analyze Audio with AuraManager</DialogTitle>
            <DialogDescription className="text-foreground/70">
              AuraManager will analyze your track and provide insights on style, mood, production quality, and recommendations.
            </DialogDescription>
          </DialogHeader>
