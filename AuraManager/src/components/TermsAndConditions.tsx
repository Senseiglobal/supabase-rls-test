            ...
            <div className="space-y-6 text-sm">
              <section>
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Your Content Ownership:</strong> You retain full ownership of all content, music, and data you upload or connect to AuraManager. We never claim rights to your creative work.
                  </p>
                  <p>
