  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Loading size="lg" text="Loading AuraManager..." />
      </div>
    );
  }
                        ...
                        <div className="flex-1 flex flex-col min-w-0">
                          ...
                          <div className="sticky top-0 z-40 flex h-14 md:h-16 items-center gap-3 md:gap-4 border-b border-border bg-background px-4 md:px-6 lg:px-8">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="hidden md:inline text-base md:text-lg font-bold bg-gradient-to-r from-accent to-accent-hover bg-clip-text text-transparent">AuraManager</span>
                            </div>
