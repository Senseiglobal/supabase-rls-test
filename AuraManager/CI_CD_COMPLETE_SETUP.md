# Complete CI/CD Setup Guide for Aura Manager
...
- Changes in: `Aura Manager/` directory
...
# Make changes in Aura Manager directory
...
3. **Build Directory:** Workflows target `Aura Manager/` specifically
